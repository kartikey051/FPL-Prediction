...
# Create a dictionary to save model along with metadata
model_package = {
...
print(f"  Package includes: model, scalers, feature columns, and metrics")
print(f"\nTo load the model later:")
print(f"  with open('{model_filename}', 'rb') as f:")
print(f"      model_package = pickle.load(f)")
print(f"      model = model_package['model']")
print(f"      scaler_X = model_package['scaler_X']")
print(f"      scaler_y = model_package['scaler_y']")